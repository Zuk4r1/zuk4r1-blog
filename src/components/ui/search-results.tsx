...
export const SearchResults = memo(function SearchResults({ results, isLoading, isVisible, onClose, query }: SearchResultsProps) {
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 text-[10px] text-cyber-muted font-mono mb-2">
                            <div className="flex items-center gap-1">
                              ...
                              <span>{formatPostDate(result.post.date)}</span>
                            </div>
