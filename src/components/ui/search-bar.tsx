      ...
      <form onSubmit={handleSubmit}>
        <div className="relative group">
          <motion.div
            ...
            transition={{ duration: 1.5, repeat: isFocused || query ? Infinity : 0 }}
          ...
          {/* Efecto de escaneo mientras se busca */}
          {(isFocused || query) && (
            <motion.div
              className="absolute inset-0 rounded-lg bg-gradient-to-r from-cyber-primary/0 via-cyber-primary/10 to-cyber-primary/0 pointer-events-none"
              animate={{
                x: ['-100%', '100%'],
              }}
              transition={{
